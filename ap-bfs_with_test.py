...
def AP_BFS(G, source):
    ...
    tree = nx.algorithms.traversal.dfs_tree(G, source=source)  # 鐢╠fs鎵剧敓鎴愭爲
    ...
    euler_tour = list(nx.algorithms.traversal.dfs_preorder_nodes(tree, source=source))  # 鐢╠fs鎵剧敓鎴愭爲鐨勬鎷夐�斿緞锛岃繑鍥炲悇鐐圭殑鍑虹幇娆″簭
